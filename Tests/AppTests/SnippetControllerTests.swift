//
//  SnippetControllerTests.swift
//  MSJSON
//
//  Created by Alessio Arsuffi on 25/05/2017.
//
//
...
/// a Droplet.
class SnippetControllerTests: TestCase {
    let initialMessage = "I'm a snippet"
    ...
    /*func fetchOne(id: Int) throws {
        ...
        let res = try controller.show(request: req, snippet: post).makeResponse()
...
extension SnippetControllerTests {
    /// This is a requirement for XCTest on Linux
    /// to function properly.
    /// See ./Tests/LinuxMain.swift for examples
    static let allTests = [
        ("testSnippetRoutes", testSnippetRoutes),
        ]
}
